...
(function(tinymce) {
    ...
    tinymce.create('tinymce.plugins.CurrentTag', {
            ...
            ed.onNodeChange.add(function(ed, cm, n, co, ob) {
                ...
                getParent(function(n) {
                    ...
                    if (tag !== null) {
                        ...
                        p = $('#currentPath')[0];
                        if (p.hasChildNodes()) {
                            p.insertBefore(t.editor.dom.create('span', {
                                'aria-hidden': 'true'
                            }, '\u00a0\u00bb '), p.firstChild);
                ...
                $('#currentPath').find('a').click(function() {
            ...
            ed.addCommand('closeCurrentTag', function() {
                ...
                if (node.getAttribute('_tag')) {
                    if ($(node).text() === '') {
                        ...
                        range = t.editor.selection.getRng(true);
                        if (node.nextSibling) {
        ...
        createControl: function(n, cm) {
            var c;
            if (n === 'currenttag') {
                c = new tinymce.ui.Label('currentPath');
                return cm.add(c);
            }
            return null;
        }
